<?php
session_start();
if ($_SESSION['admin']['allow_user'] == 0)
{
	echo '<style>
		.insertusers{
		pointer-events: none;
		...
		<table width="100%" cellspacing="0" cellpadding="10" border="1">
			...
			<?php foreach($data as $v): ?>
				<tr>
					...
					<td><a class="insertusers" href="modUser.php?id=<?php echo $v['id'] ?>">修改</a> | <a class="insertusers" href="del.php?id=<?php echo $v['id'] ?>&act=delUser">删除</a></td>
				</tr>
			<?php endforeach; ?>
